...
wget https://raw.githubusercontent.com/EngineerChris/jenkins-controller-agent-project/maven-sonarqube-nexus-jenkins/settings.xml -P /home/jenkinsmaster/.m2/
